...
<head>
    ...
    <link rel="stylesheet" href="/ImmoConnect/public/css/tailwind.css">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        <img src="/ImmoConnect/public/images/Logo.png" class="h-8 me-3" alt="FlowBite Logo" />
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">ImmoConnect</span>
                    </a>
                </div>
    ...
    <div class="p-4 sm:ml-64 bg-slate-500">
        <div class=" grid grid-cols-2 p-4 border-2 bg-red-700 border-dashed rounded-lg mt-14">
            ...
            <div class=" bg-blue-700">
                ...
                <div
                    ...
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="/ImmoConnect/public/images/me.jpg"
                            alt="Bonnie image" />
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">ENNEDDI Omar</h5>
            ...
            <div class=" bg-green-600">
                ...
                <div
                    class="w-full p-4 pt-3 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flow-root">
                        <ul>
                            <?php foreach ($biens as $bien): ?>
                                <li class="py-3 sm:py-4 border-b border-gray-200 dark:border-gray-600">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img class="w-8 h-8 rounded-full"
                                                src="/ImmoConnect/public/images/<?= $bien['image_path']?>" alt="User Image">
                                        </div>
                                        <div class="flex-1 min-w-0 ms-4">
                                            <p class="text-sm font-medium text-gray-900 truncate dark:text-white">
                                                <?= $bien['titre'] ?>
